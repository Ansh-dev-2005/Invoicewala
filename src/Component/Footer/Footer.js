        ...
        <div className="flex flex-col  md:flex-row justify-between p-8">
          <div className="flex-1">
            ...
            <div className="flex space-x-4">
              ...
              <p>
                1ST-FR, FL-1A, 393 PURBACHAL MAIN RD, Haltu, Kolkata West Bengal
                700078
              </p>
            </div>
          </div>
          ...
          <div className="flex-1">
            ...
            <p className="text-white ">
              ...
              engagement, and embracing eco-friendly billing. With our platform,
              you can easily share invoices via WhatsApp, revolutionizing
              e-invoicing while reducing environmental impact. Discover how
              Invoicewala can optimize your business operations and empower your
              organization for success. Join us in paving the way for
              efficiency, effectiveness, and eco-friendly billing solutions.
            </p>
            <p className="text-white">
          ...
          <div className="flex-1 md:text-right ">
            ...
            <Link to="http://invoicewala.in/app" className="block">
              Portal
            </Link>
